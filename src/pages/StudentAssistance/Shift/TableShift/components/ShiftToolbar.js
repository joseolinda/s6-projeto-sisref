  ...
  return (
    <div
      ...
      <div className={classes.row}>
        <Typography variant="h5" className={classes.title}>{'Lista de Turnos'}</Typography>
        <span className={classes.spacer} />
        <Button variant="contained" color="primary" className={classes.exportButton}
          onClick={onClickHandleCampus}>Novo turno</Button>
      </div>
      <div className={classes.row}>
        <SearchInput
...
export default withRouter(ShiftToolbar);
