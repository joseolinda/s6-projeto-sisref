                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        <Nav className="mr-auto">
                            <NavDropdown title="Cadastros" id="basic-nav-dropdown">
                                <NavDropdown.Item as={Link} to={"/admin/campus"}>Campi</NavDropdown.Item>
                                <Dropdown.Divider />
                                <NavDropdown.Item as={Link} to={"/admin/config"}>Configurações</NavDropdown.Item>
                                <Dropdown.Divider />
                                <NavDropdown.Item as={Link} to={"/admin/users"}>Usuários</NavDropdown.Item>
                            </NavDropdown>
                            <NavDropdown title="Relatórios" id="basic-nav-dropdown">
                                <NavDropdown.Item as={Link} to={"/admin/reports"}>Total de Refeições</NavDropdown.Item>
                            </NavDropdown>
                            <NavDropdown title="Outros" id="basic-nav-dropdown">
                                <NavDropdown.Item as={Link} to={"/admin"}>Action</NavDropdown.Item>
                            </NavDropdown>
                            
                        </Nav>
                    </Navbar.Collapse>
                        <Navbar.Brand>
                        <span class="navbar-brand" href="#">Olá, {name}</span>
                        </Navbar.Brand>
                        <Navbar.Brand>
